...
with DMXInterface("FT232R") as interface:
    ...
    # Send a pause
    lightA.set_colour(testCommands.Volume1DownCommandA)
    lightB.set_colour(testCommands.Volume1DownCommandB)

    print("Sending a Volume 1 Down command, volume should go down")
