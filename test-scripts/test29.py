...
with DMXInterface("FT232R") as interface:
    ...
    print("Playing sound 264, looping, moderate volume - it should replace 262")
    ...
    print("Playing sound 265, looping, moderate volume - it should replace 264")
    ...
    print("Playing sound 266, looping, moderate volume - it should replace 265")
    ...
    print("Playing sound 267, looping, moderate volume - it should replace 266")
    ...
    print("Playing sound 268, looping, moderate volume - it should replace 267")
    ...
    print("Playing sound 269, looping, moderate volume - it should replace 268")
    ...
    print("Playing sound 270, looping, moderate volume - it should replace 269")
    ...
    print("Playing sound 271, looping, moderate volume - it should replace 270")
