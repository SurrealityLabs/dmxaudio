...
with DMXInterface("FT232R") as interface:
    ...
    # Play the sound
    lightA.set_colour(testCommands.PlaySound260LoopOnceA)
    lightB.set_colour(testCommands.PlaySound260LoopOnceB)
    ...
    # Play the sound
    lightA.set_colour(testCommands.PlaySound261LoopOnceA)
    lightB.set_colour(testCommands.PlaySound261LoopOnceB)
    ...
    # Play the sound
    lightA.set_colour(testCommands.PlaySound262LoopOnceA)
    lightB.set_colour(testCommands.PlaySound262LoopOnceB)
    ...
    # Play the sound
    lightA.set_colour(testCommands.PlaySound263LoopOnceA)
    lightB.set_colour(testCommands.PlaySound263LoopOnceB)
