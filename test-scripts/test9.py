...
with DMXInterface("FT232R") as interface:
    ...
    # Send a pause
    lightA.set_colour(testCommands.Volume1UpCommandA)
    lightB.set_colour(testCommands.Volume1UpCommandB)

    print("Sending a Volume 1 Up command, volume should increase")
