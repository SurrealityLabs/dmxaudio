...
with DMXInterface("FT232R") as interface:
    ...
    # Send a pause
    lightA.set_colour(testCommands.Volume0DownCommandA)
    lightB.set_colour(testCommands.Volume0DownCommandB)

    print("Sending a Volume 0 Down command, nothing should change")
