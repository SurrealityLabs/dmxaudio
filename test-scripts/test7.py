...
with DMXInterface("FT232R") as interface:
    ...
    # Send a pause
    lightA.set_colour(testCommands.Pause0CommandA)
    lightB.set_colour(testCommands.Pause0CommandB)

    print("Sending a Pause 0 command, nothing should change")
    ...
    # Send a resume
    lightA.set_colour(testCommands.Resume1CommandA)
    lightB.set_colour(testCommands.Resume1CommandB)

    print("Sending a Resume 1 command, nothing should change")
